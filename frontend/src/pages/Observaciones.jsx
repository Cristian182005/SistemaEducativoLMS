        ...
        <div className="card border-0 shadow-sm p-4 mb-4" style={{ borderRadius: "16px", background: "linear-gradient(135deg, #115133 0%, #1a6b45 100%)", color: "#fff" }}>
          <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
            <div className="flex-grow-1">
              <h2 className="fw-bold m-0" style={{ fontSize: "26px" }}>Módulo de Observaciones</h2>
              <p className="text-white-50 small m-0 mt-1">Gestión de observaciones estudiantiles.</p>
            </div>
          </div>
        </div>
